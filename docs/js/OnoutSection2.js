    ...
    connectedCallback(){
        ...
        <div class='max-w-[52.5rem] w-full h-full flex justify-center items-center'>
            <picture class='max-w-[60rem] w-full h-full flex justify-center items-center px-[1.25rem] sm:px-[3rem]'>
                <source srcset='../images/sections/mobile/section2.png' media="(max-width: 640px)" />
                <img src='../images/sections/pc/section2.png' />
            </picture>    
        </div>
        ...
        <img src='../icons/store/google.svg' class='w-[7.38rem] sm:w-[11.5rem]'  />
        </a>
        <a href='https://apps.apple.com/app/id6446235118' target='_blank'>
        <img src='../icons/store/apple.svg'  class='w-[7.38rem] sm:w-[11.5rem]'' />
        </a>
        </div>
        </div>`
    }
